using Tyuiu.PlesovskikhBA.Sprint6.Task4.V2.Lib;
using System.Windows.Forms.VisualStyles;
namespace Tyuiu.PlesovskikhBA.Sprint6.Task4.V2
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 4 выполнил студент группы СМАРТб-24-1 Плесовских Б. А.", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
